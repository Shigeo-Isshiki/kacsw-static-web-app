...
const isSingleByteAlnumOnly = global.isSingleByteAlnumOnly || (window && window.isSingleByteAlnumOnly);
...
if (!isSingleByteAlnumOnly || !toFullWidthKatakana || !toFullWidthHiragana || !toHalfWidthKana || !toFullWidth || !toHalfWidth || !assertEmailAddress)
...
try {
    ...
    console.error('FAIL: toFullWidthHiragana halfwidth kana -> hiragana', e && e.message ? e.message : e);
    process.exitCode = 2;
}
...
try {
    ...
    console.error('FAIL: toFullWidthKatakana throws on invalid input', e && e.message ? e.message : e);
    process.exitCode = 2;
}
