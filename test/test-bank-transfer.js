	...
	BANK.parseZenginFile({ encoding: 'UTF8', strict: true })
		.then((res) => {
			try {
				...
				assert.strictEqual(res.headerData.typeCode, '21');
				...
				assert.strictEqual(res.records[0].employeeCode1, '');
				assert.strictEqual(res.records[0].employeeCode2, '');
