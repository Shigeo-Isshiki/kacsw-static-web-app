...
try {
  ...
  assert.strictEqual(norm, '08012345678', 'normalizePhoneNumber removes symbols and returns digits only');
...
try {
  ...
  assert.strictEqual(isValidPhoneNumber(wireless), false, `${wireless} は現在無効と判定される（実装に依存）`);
