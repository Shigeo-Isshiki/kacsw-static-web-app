 ...
 * 電話番号データ（_pn_phoneNumberData関数内に格納）は、総務省2026年2月版の公開情報（https://www.soumu.go.jp/main_sosiki/joho_tsusin/top/tel_number/index.html）に基づいています。
 * 2026年3月1日版までの公開情報を確認した時点では差分がなかったため、データ定義は従来内容を継続しています。
 ...
 */
// ==================== 電話番号データ定義ここから ====================
// ※総務省公開情報は2026年3月1日版まで確認済みです。今回の確認では差分がなかったため、データ定義は従来のままです。
